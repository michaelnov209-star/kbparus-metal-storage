  ...
  const notices =
    input.provider === "google"
      ? [
          ...
          "Позиция рассчитана по всем показам Google Search Console: запросы с большим количеством показов влияют на итог сильнее. Для одного запроса используйте фильтр.",
      ...
      : [
          "Позиция рассчитана по всем показам Яндекс Вебмастера: запросы с большим количеством показов влияют на итог сильнее. Для одного запроса используйте фильтр.",
