...
- Визуальные блоки: remote-фото и локальные фото категорий, крупные placeholder-визуалы для материалов, до/после склада, кейсы-слайдер, отзывы-слайдер, Яндекс.Карта географии поставок, баннер на основной сайт КБ Парус.
...
- Калькулятор доработан по контрасту, чтобы заголовки, параметры и результат были читаемыми на светлом фоне.
