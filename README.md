...
- Визуальные блоки: реальные remote-фото, карточки материалов, до/после склада, кейсы-слайдер, отзывы-слайдер, интерактивная карта поставок.
...
- Фото и визуальные ассеты: `data/storageSystems/visualAssets.ts`
...
- Каталог из 17 разделов по утвержденной структуре, карточки ведут внутрь категорий.
...
- Подготовить страницы разделов каталога и карточки оборудования.
