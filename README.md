...
- Hero усилен продуктовой подачей: быстрые сигналы, инженерный brief и отдельный вход в каталог.
- Каталог из 17 разделов по утвержденной структуре, с приоритетными категориями и усиленной подачей карточек.
