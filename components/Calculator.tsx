...
const profileCopy: Record<CalculatorProfileId, { title: string; shortTitle: string; description: string; image: string }> = {
  ...
  "auto-sort-metal": {
    ...
    description: "Для труб, профиля, балок и длинномерного проката с механизированной выдачей.",
...
const dimensionHints = {
  ...
  lengthMm: "Длина рабочей зоны. Для длинномера выбирайте вариант с запасом по максимальной длине.",
