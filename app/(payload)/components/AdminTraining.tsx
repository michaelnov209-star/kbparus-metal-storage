...
const steps: Step[] = [
  {
    ...
    text: "Начинайте отсюда: создать товар, загрузить фото, открыть заявки или перейти к главной странице.",
  ...
  {
    title: "Структура как на сайте",
    text: "Этот блок идёт в том же порядке, что главная страница: первый экран, каталог, калькулятор, доверие, контакты. Редактору не нужно вспоминать, где что лежит.",
    target: '[data-tour="site-map"]',
    placement: "top"
  },
  {
    title: "Каталог в правильном порядке",
    text: "Категории и товары показаны так же, как на витрине. Из каждой строки можно открыть редактирование или посмотреть страницу на сайте.",
    target: '[data-tour="catalog-map"]',
    placement: "top"
  },
  {
  ...
  },
  {
    ...
    text: "Здесь видно, что важно контент-менеджеру, менеджеру продаж, инженеру и руководителю. Это основа для будущих прав доступа.",
    target: '[data-tour="roles-map"]',
    placement: "top"
  },
  {
    title: "Preview и здоровье сайта",
    text: "После правок проверяйте публичную страницу, заявки и /api/health. Так админка становится рабочим центром контроля, а не просто набором форм.",
